...
export default class MainMenu extends Phaser.Scene {
  ...
  create(): void {
    ...
    // this.add.text(this.scale.width / 2, 350, this.strings.intro.selectLang, {
    //   fontSize: '28px',
    //   color: '#ffffff'
    // }).setOrigin(0.5, 0.5);
    ...
    // Název hry - Nadpis
		...
		nazevHry.setStyle({ "align": "center", "color": "#d1d289ff", "fontFamily": "Playpen Sans Arabic", "fontSize": "96px", "fontStyle": "bold", "stroke": "#931616ff", "strokeThickness": 5, "shadow.offsetX": 5, "shadow.offsetY": 5, "shadow.fill": true });
  ...
  private selectLang(lang: Lang): void {
    // uložení dat do global registry
    this.registry.set('lang', lang);
    this.registry.set('strings', this.cache.json.get(`locale-${lang}`)!);
